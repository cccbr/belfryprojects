...
For ringers, these are some of the key issues:
...
Once the scope of the project has been outlined in detail, the Project Leader will finalise the details, and draw up all the documentation. First it will be the tower authorities who will have to give permission for the project to go ahead and they in turn will need to be convinced that all the information required for [higher level approvals](../080-permissions-approvals) is available.
